  ...
  < >
    ...
    <div className='h-screen w-full flex justify-between items-center py-4 px-4'>
        ...
        <form className=' flex flex-col items-center justify-between'>
          ...
          <button className='bg-yellow-500 rounded-lg hover:bg-yellow-600 py-2 hover:-translate-y-[2px]  px-4 font-bold focus: shadow-lg transform active:scale-90 transition-transform mt-3' onClick={handlePay} >Make Payment</button>
